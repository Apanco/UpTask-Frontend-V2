    ...
    return (
        <li>
            <Card 
                ...
                className=" bg-transparente w-full pb-5 text-muted-foreground cursor-default">
                <div {...listeners} className={`cursor-grab ${styleCard} w-full text-muted-foreground flex justify-center items-center border-b h-5`}>
